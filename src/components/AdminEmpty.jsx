...
function TiltCard({ children }) {
  ...
  return (
    <div
      ...
      className="bg-white border border-slate-200 rounded-[10px] p-10 flex flex-col items-center text-center"
    ...
    <div className="p-8">
      ...
      <div className="grid md:grid-cols-2 gap-6 max-w-3xl" style={{ perspective: '1200px' }}>
        ...
        <TiltCard>
          ...
          <h2 className="text-lg font-bold font-display text-slate-900 mt-6 mb-2">No products yet</h2>
        ...
        <TiltCard>
          ...
          <h2 className="text-lg font-bold font-display text-slate-900 mt-6 mb-2">No orders yet</h2>
          <p className="text-sm text-slate-400 leading-relaxed mb-6 max-w-52">
